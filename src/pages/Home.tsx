...
import { exportReadings } from "../helper/exportReadings";
import { parseImportReadings } from "../helper/parseImportReadings";
...
import { unflattenObject } from "../helper/unflattenObject";
...
export const Home = () => {
  ...
  const columns = useMemo<GridColDef[]>(
    () => [
      ...
      { field: "customer.id", headerName: "Kunde: ID", minWidth: 300 },
      {
